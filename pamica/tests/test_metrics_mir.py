"""Unit tests for ``pamica.metrics.mir`` (issue #134, MIR port phase 1).

MIR is backend-agnostic pure NumPy, so it lives directly under ``pamica/tests/``
...
from pamica.metrics.mir import _marginal_entropies, mir
